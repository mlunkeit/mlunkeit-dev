...
import { notesDocs, indexPage, type DocItem } from "../config/docsConfig";
...
export default function Notes()
{
  ...
  return (<div className="min-h-full w-full flex flex-row sm:p-4 space-x-4 bg-ctp-surface0 sm:bg-transparent">
    <Sidebar>
      {notesDocs.map((item) => renderDocItemInSidebar(item, "/notes"))}
    </Sidebar>

    <div className="flex-1 p-4 sm:bg-ctp-base sm:rounded-2xl sm:border border-ctp-surface2 markdown overflow-y-scroll">
      <Markdown
