  ...
  return (
    <div className="p-4 w-full h-full flex flex-col items-center overflow-y-scroll overflow-x-scroll">
      <div className="paragraph w-full lg:w-3xl">
        ...
        <p>Empfänger der Daten sind ggf. technische Dienstleister, die für den Betrieb und die Wartung unserer Webseite als Auftragsverarbeiter tätig werden.</p>
        <h4>Speicherdauer</h4>
        <p>Daten bleiben bei uns, bis der Zweck für die Datenspeicherung entfällt. Zwingende gesetzliche Bestimmungen – insbesondere gesetzliche Aufbewahrungsfristen – bleiben hiervon unberührt.</p>
