import { Rust, C, CPlusplus, Java, LinuxTux, GitIcon, DockerIcon, MysqlIcon, Gopher } from "@dev.icons/react/mono";
...
export default function Hero()
{
  return (
    <div className="font-mono text-ctp-text min-h-[85vh] w-full flex items-center justify-center p-4 md:p-8">
      <div className="bg-ctp-base border-ctp-surface0 border-2 rounded-xl p-2">
        ...
        <div className="p-4">
          ...
          <pre><span className="text-ctp-green">guest@mlunkeit.dev</span>:<span className="text-ctp-blue">~</span>$ cat info.md</pre>

          <div className="space-y-3 text-ctp-subtext pl-2 mt-2">
            <p>Tech Stack</p>
            <p className="flex items-center gap-5 flex-wrap">
              <span className="text-ctp-blue font-bold">➔ Systems Programming: </span>
            ...
            <p className="flex items-center gap-5 flex-wrap">
              <span className="text-ctp-green font-bold">➔ Backend & Enterprise: </span>
            ...
            <p className="flex items-center gap-5 flex-wrap">
              <span className="text-ctp-mauve font-bold">➔ Data & Infra: </span>
          ...
          <div className="mt-2"><span className="text-ctp-green">guest@mlunkeit.dev</span>:<span className="text-ctp-blue">~</span>$ <span className="w-2 h-4 bg-ctp-text animate-terminal-cursor inline-block" /></div>
        </div>
      </div>
    </div>
  )
